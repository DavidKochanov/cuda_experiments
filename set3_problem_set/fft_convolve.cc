...
(sizeof(cufftComplex) * impulse_length));
	...
	cudaMemset(input_padding, 0, (padded_length - N) * sizeof(cufftComplex));
	cudaMemset(imp_padding, 0, (padded_length - impulse_length) * sizeof(cufftComplex));
...
int main(int argc, char **argv){
    ...
    int max_time_allowed_in_seconds = 10000;
